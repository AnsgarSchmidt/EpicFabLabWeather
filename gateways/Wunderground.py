...
class Wunderground(threading.Thread):
    ...
    def _sendData(self):
        ...
        #url += "&leafwetness=%f" % (self._getData('davis/barometer_mbar') * 0.0145038)
        #url += "&solarradiation=%f" % (self._getData('davis/barometer_mbar') * 0.0145038)
        #url += "&AqPM2.5=%f" % (self._getData('davis/barometer_mbar') * 0.0145038)
        #url += "&AqOZONE=%f" % (self._getData('davis/barometer_mbar') * 0.0145038)
